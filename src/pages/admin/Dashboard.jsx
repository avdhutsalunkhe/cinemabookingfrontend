...
// लक्षात घ्या: dummyDashboardData, ChartLineIcon, CircleDollarSignIcon, PlayCircleIcon, UsersIcon हे import किंवा डिफाइन केलेले असावेत.
...
const Dashboard = () => {
  ...
  // चुकीचा भाग: <Titel text1={Admin}  text2 ={Dashboard}/>
  // Admin आणि Dashboard हे व्हेरिएबल्स नाहीत, ते स्ट्रिंग म्हणून द्यावे लागेल.

  return !loading ? (
    <>
    <div>
      <Titel text1="Admin" text2="Dashboard" />
