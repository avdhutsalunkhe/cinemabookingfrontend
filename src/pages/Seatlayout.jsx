        ...
        {Array.from({ length: count }, (_, i) => {
          ...
          return (
            <button
              ...
              className={`h-8 w-8 rounded border border-primary/60 cursor-pointer ${isSelected ? "bg-primary text-white" : ""}`}
            >
              {seatId}
            </button>
          );
          ...
          {show.dateTime[date].map((item) => (
            <div
              ...
              className={`flex items-center gap-2 px-6 py-2 w-max rounded-r-md cursor-pointer transition
                ${selectedTime?.time === item.time ? 'bg-red-600 text-white' : 'hover:bg-primary-dull'}
