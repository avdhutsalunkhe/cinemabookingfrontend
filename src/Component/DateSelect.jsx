...
import { ChevronLeft, ChevronRight } from 'lucide-react' // or use HeroIcons if you prefer
    ...
    >
      ...
      <span>{new Date(date).toLocaleDateString("en-US", { month: "short" })}</span>
        ...
        <button 
          ...
          className='bg-primary px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer'
        >
          Book Now
        </button>
